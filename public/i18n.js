...
(function () {
  ...
  const I18N = {
    en: {
      ...
      'tip.integration': '• Drop-in = one component renders the whole payment method list.\n\u200b• Components = Google Pay, Apple Pay and the card form are mounted separately, each on its own.',
      ...
      'label.installments': 'Installments',
      'tip.installments': 'Enable installment options in the card form. \nAvailable values depend on the selected country (e.g. Mexico: 3/6/9/12/18, Brazil: 2-12, Japan: 2-12 + revolving/bonus).',
      'installments.off': 'Disabled',
      'installments.on': 'Enabled',
      ...
      'preset.installments.title': '4. Test credit card installments',
      'preset.installments.desc': 'Click <b>Start Checkout</b>, then choose the number of installments on the checkout page.',
      'preset.paybylink.title': '5. Generate a Pay by Link',
      'preset.reset.title': 'Restore to default',
      'preset.reset.desc': 'Reset all settings back to default values.',
      'pbl.title': 'Payment link created',
      'pbl.note': 'Open this link to pay on the Adyen-hosted payment page.',
      'pbl.copy': 'Copy',
      'pbl.copied': 'Copied',
      'pbl.open': 'Open link',
      'pbl.close': 'Close',
      'pbl.reference': 'Reference',
      'pbl.amount': 'Amount',
      'pbl.expiresAt': 'Expires at',
      'pbl.error': 'Could not create the payment link.',
      ...
      'cmp.unreachable': 'Could not load this payment method\u2019s SDK. Check that the network can reach pay.google.com / applepay.cdn-apple.com.',
    ...
    zh: {
      ...
      'tip.integration': '• Drop-in = 由一个组件渲染整个支付方式列表。\n\u200b• Components = Google Pay、Apple Pay 和卡片表单各自作为独立组件单独挂载。',
      'label.threeDS': '3DS 模式',
      'tip.threeDS': '• Native = 3DS2 在商户页面内渲染。\n• Redirect = 购物者被跳转到发卡行的验证页面。',
      'label.installments': '分期',
      'tip.installments': '在卡片表单中启用分期选项。\n可用期数取决于所选国家（例如墨西哥：3/6/9/12/18，巴西：2-12，日本：2-12 + revolving/bonus）。',
      'installments.off': '关闭',
      'installments.on': '开启',
      'btn.continue': '开始结账',
      'ph.optional': '可选',
      ...
      'preset.chargeback.title': '3. 测试拒付',
      'preset.chargeback.desc': '在 /payment 请求中发送 <b>holderName</b> 参数，从而在测试环境触发拒付。<br>你可能需要等待数小时才能收到拒付 webhook',
      'preset.installments.title': '4. 测试信用卡分期',
      'preset.installments.desc': '测试巴西信用卡分期，点击<b>开始结账</b>然后在收银台选择分期期数。',
      'preset.paybylink.title': '5. 生成 Pay by Link',
      'preset.reset.title': '恢复默认',
      'preset.reset.desc': '将所有设置重置为默认值。',
      'pbl.title': '支付链接已生成',
      'pbl.note': '打开该链接可在 Adyen 托管的支付页面完成支付。',
      'pbl.copy': '复制',
      'pbl.copied': '已复制',
      'pbl.open': '打开链接',
      'pbl.close': '关闭',
      ...
      'cmp.unreachable': '无法加载该支付方式的 SDK，请检查网络是否能访问 pay.google.com / applepay.cdn-apple.com。',
